...
import com.berfinilik.mychatapp.notifications.entity.NotificationData
...
import com.berfinilik.mychatapp.notifications.network.RetrofitInstance
...
class ChatAppViewModel : ViewModel() {
    ...
    fun updateProfile() = viewModelScope.launch(Dispatchers.IO) {
        ...
        // chatlist ve recent list mesajını, image vb. güncellemek
