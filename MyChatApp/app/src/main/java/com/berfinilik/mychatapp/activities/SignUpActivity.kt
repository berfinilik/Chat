...
import com.berfinilik.mychatapp.databinding.ActivitySignUpBinding
...
class SignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.signUpBtn.setOnClickListener {
            ...
            if (binding.signUpEmail.text.isEmpty()){
                Toast.makeText(this, "Emailinizi Giriniz", Toast.LENGTH_SHORT).show()
            }
    ...
    private fun createAnAccount(name: String, password: String, email: String) {
        ...
        pd.show()
        pd.setMessage("Kullanıcı Kaydediliyor")
